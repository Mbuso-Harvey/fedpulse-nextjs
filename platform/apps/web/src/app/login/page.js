    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4">
      <div className="w-full max-w-md bg-background rounded-2xl shadow-xl border border-border p-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-muted-foreground text-center mt-2">Sign in to your FedPulse account</p>
        </div>

        <div className="flex flex-col gap-3 mb-6">
          <button onClick={() => handleSocialLogin('microsoft')} className="flex items-center justify-center gap-3 w-full h-11 px-4 bg-background border border-input rounded-md hover:bg-muted/50 transition-colors font-medium text-sm">
          ...
          <button onClick={() => handleSocialLogin('google')} className="flex items-center justify-center gap-3 w-full h-11 px-4 bg-background border border-input rounded-md hover:bg-muted/50 transition-colors font-medium text-sm">
          ...
          <button onClick={() => handleSocialLogin('linkedin')} className="flex items-center justify-center gap-3 w-full h-11 px-4 bg-background border border-input rounded-md hover:bg-muted/50 transition-colors font-medium text-sm">
